        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-8 mx-auto text-center">
                    <h4 class="fw-bold">Happy Clients</h4>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-lg-5 mb-5 mb-lg-0">
                    ...
                    <p class="text-muted mb-1">hello@example.com</p>
                ...
                <div class="col-12 col-lg-6 offset-lg-1">
                    <form action="#">
                        ...
                        <textarea class="form-control mb-3" name="message" cols="30" rows="10" placeholder="Your Message...">
                        </textarea>
                        <div class="d-flex justify-content-center">
                            <button class="btn bg-gradient-primary w-50">Send</button>
                        </div>
                    </form>
                </div>
            </div>
